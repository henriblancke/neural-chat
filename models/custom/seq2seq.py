...
from models.custom.beam_decoder import beam_decoder
...
def rnn_decoder(decoder_inputs, initial_state, cell,
                loop_function=None,
                scope=None):
    """RNN decoder for the sequence-to-sequence models.
...
def embedding_rnn_seq2seq(encoder_inputs, decoder_inputs, cell, num_encoder_symbols,
                          ...
                          beam_search=True,
                          beam_size=10):
    """Embedding RNN sequence-to-sequence models.

    This models first embeds encoder_inputs by a newly created embedding (of shape
...
def attention_decoder(decoder_inputs, initial_state, attention_states, cell,
    ...
    """RNN decoder with attention for the sequence-to-sequence models.

    In this context "attention" means that, during decoding, the RNN can look up
    information in the additional tensor attention_states, and it does this by
    focusing on a few entries from the tensor. This models has proven to yield
...
def embedding_attention_seq2seq(encoder_inputs, decoder_inputs, cell,
                                ...
                                beam_search=True,
                                beam_size=10):
    """Embedding sequence-to-sequence models with attention.
    ...
    with variable_scope.variable_scope(scope or "embedding_attention_seq2seq"):
        ...
        encoder_cell = tf.contrib.rnn.EmbeddingWrapper(cell,
                                                       embedding_classes=num_encoder_symbols,
                                                       embedding_size=embedding_size)
        encoder_outputs, encoder_state = tf.contrib.rnn.static_rnn(encoder_cell,
                                                                   encoder_inputs,
                                                                   dtype=dtype)
